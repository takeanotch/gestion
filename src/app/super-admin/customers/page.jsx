...
//         .from('sale')
//         .select('customer_id, total, date_time, status')
//         .eq('status', 'completed')
...
//         const totalSpent = clientPurchases.reduce((sum, sale) => sum + (sale.total || 0), 0)
...
//         sortedClients.sort((a, b) => b.purchaseCount - a.purchaseCount)
...
//       // Filtrer par achat si nécessaire
//       if (filters.hasPurchases === 'with') {
//         sortedClients = sortedClients.filter(client => client.purchaseCount > 0)
...
//       return { label: 'Nouveau', color: 'bg-blue-100 text-blue-800', icon: User }
//     }
...
//       } else if (diffDays <= 90) {
//         return { label: 'Occasionnel', color: 'bg-yellow-100 text-yellow-800', icon: Clock }
//       } else {
//         return { label: 'Inactif', color: 'bg-red-100 text-red-800', icon: XCircle }
//       }
//     }
//     return { label: 'Nouveau', color: 'bg-blue-100 text-blue-800', icon: User }
//   }
...
//             Gestion de votre base de clients
//           </p>
//         </div>
...
//             return (
//               <div key={client.id} className="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-sm transition-shadow">
...
//                         <span className="font-bold text-lg">{client.purchaseCount}</span>
//                       </div>
//                       <div className="text-xs text-gray-600">Achats</div>
//                     </div>
...
//                     <div className="flex items-center space-x-2 text-sm pt-3 border-t border-gray-200">
...
//                       className="flex-1 px-3 py-2 text-sm bg-gray-900 text-white hover:bg-gray-800 rounded-lg transition flex items-center justify-center space-x-2"
//                     >
...
//                       <button
//                         onClick={() => handleViewClient(client)}
//                         className="px-3 py-2 text-sm bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-lg transition"
...
//                           Moyenne par achat: {formatCurrency(selectedClient.totalSpent / selectedClient.purchaseCount)}
//                         </div>
//                       )}
//                     </div>
//                   </div>
...
//                                       {sale.sale_items?.[0]?.count || 0} article{sale.sale_items?.[0]?.count > 1 ? 's' : ''}
//                                     </span>
//                                   </div>
//                                   <div className="flex items-center space-x-2">
