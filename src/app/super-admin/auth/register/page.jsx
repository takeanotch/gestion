...
//     } else if (formData.username.length < 3) {
//       newErrors.username = t('min3Chars')
//     }

//     if (!formData.password) {
//       newErrors.password = t('passwordRequired')
//     } else if (formData.password.length < 6) {
//       newErrors.password = t('min6Chars')
//     } else if (!/(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/.test(formData.password)) {
...
//     if (formData.role === 'vendor' && !formData.shop_name) {
//       newErrors.shop_name = t('storeNameRequired')
//     }
...
//       if (error) {
//         throw new Error(`${t('registrationError')}: ${error.message}`)
//       }
...
//       setErrors({ 
//         general: error.message || t('registrationGeneralError')
//       })
//     } finally {
//       setLoading(false)
//     }
...
//               </svg>
//             </div>
//             <h1 className="text-2xl font-bold text-gray-900 mb-2">{t('registrationSuccess')}</h1>
//             <p className="text-gray-600 mb-6">
...
//                             className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
//                           >
//                             <option value="vendor">{t('sellerStore')}</option>
//                             <option value="admin">{t('administrator')}</option>
//                             <option value="super-admin">{t('superAdmin')}</option>
//                           </select>
//                           <p className="mt-2 text-xs text-gray-500">
//                             {t('adminValidationNote')}
//                           </p>
//                         </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      <div className="h-screen flex flex-col">
        ...
        {/* Contenu principal avec scroll vertical uniquement si nécessaire */}
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <form onSubmit={handleSubmit}>
              {/* Grid principale - Tous les champs visibles */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          value={formData.full_name}
                          onChange={handleInputChange}
                          className={`w-full px-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${
                            errors.full_name 
                              ? 'border-red-500' 
                              : 'border-gray-300'
                          }`}
                ...
                {/* Colonne 2: Sécurité et professionnel */}
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-white p-6 rounded-xl border border-gray-200">
                    ...
                    <div className="space-y-4">
                      ...
                      {formData.role === 'vendor' && (
                        <div>
                          ...
                          />
                          {errors.shop_name && (
                            <p className="mt-1 text-xs text-red-600">{errors.shop_name}</p>
                          )}
                        </div>
                      )}
                    </div>
                ...
                {/* Colonne 3: Adresse et soumission */}
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-white p-6 rounded-xl border border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                      <span className="w-8 h-8 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center mr-3">
                        4
                      </span>
                      {t('address')}
                    </h3>
                  ...
                  <div className="bg-white p-6 rounded-xl border border-gray-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                      >
                        {loading ? (
                          <span className="flex items-center justify-center">
                            <svg className="animate-spin h-5 w-5 mr-3 text-white" viewBox="0 0 24 24">
