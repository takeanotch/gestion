    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
              ...
              <div className="space-y-3">
                ...
                {sale.updated_at !== sale.created_at && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatDate(sale.updated_at)}</span>
                  </div>
                )}
                
                {statusHistory.length > 0 && (
                  <div className="pt-3 border-t border-gray-200">
                    <div className="text-sm font-medium text-gray-900 mb-2">Changements de statut:</div>
                    <div className="space-y-2">
                      {statusHistory.map((history) => (
                        <div key={history.id} className="flex items-start space-x-3 p-2 bg-gray-50 rounded">
                          <div className="flex-shrink-0">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500">
                              par {history.user} • {formatDate(history.created_at)}
                            </div>
                          </div>
                        </div>
                      ))}
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-sm text-gray-500">
            ID de la vente: <span className="font-mono">{sale.id}</span>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            {client && (
              <button
                onClick={() => router.push(`/super-admin/sales/new?client=${client.id}`)}
                className="px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition"
              >
                Nouvelle vente avec ce client
              </button>
            )}
          </div>
        </div>
