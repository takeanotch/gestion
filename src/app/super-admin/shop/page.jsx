...
export default function ShopConfigPage() {
  ...
  const tabs = [
    ...
    { id: 'suppliers', label: 'Fournisseurs', icon: <Users size={18} /> },
    { id: 'custom', label: 'Personnalisé', icon: <Layers size={18} /> },
  ];
  ...
  const renderActiveTabContent = () => {
    switch (activeTab) {
      ...
      default:
        return renderOriginalTabContent();
    }
  };

  const renderOriginalTabContent = () => (
    <form onSubmit={handleSubmit(onSubmit)}>
      {/* Onglet Général */}
      {activeTab === 'general' && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-4 md:p-6">
        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              {['general', 'images', 'messages', 'printing', 'schedule', 'online', 'custom'].includes(activeTab) && (
                <button
                  onClick={handleSubmit(onSubmit)}
                  disabled={saving}
                  className="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center space-x-2"
        ...
        {/* Footer avec bouton de sauvegarde - seulement pour les onglets d'origine */}
        {['general', 'images', 'messages', 'printing', 'schedule', 'online', 'custom'].includes(activeTab) && (
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="flex justify-end">
              <button
