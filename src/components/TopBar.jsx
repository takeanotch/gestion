...
//   return (
//     <header className="sticky top-0 z-20 bg-white border-b border-gray-200 shado">
...
//               <button
//                 onClick={onMenuClick}
//                 className="p-2 mr-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none"
//               >
...
//                   <span>Bienvenue, {user.full_name?.split(' ')[0] || 'Utilisateur'}</span>
//                 </div>
//               )}
//             </div>
//           </div>
