...
// //       // La suppression en cascade s'occupe du stock
...
// //         >
// //           {view === 'list' ? '+ Ajouter un produit' : '← Liste des produits'}
// //         </button>
// //       </div>
...
// //                     className="rounded"
// //                   />
// //                   <span className="text-sm">Afficher seulement le stock faible</span>
// //                 </label>
// //               </div>

// //               <div className="flex justify-end items-end">
// //                 <button
// //                   onClick={() => setFilters({ category: '', lowStock: false })}
...
//     p.stock?.[0]?.quantity <= p.stock?.[0]?.minimum_threshold
//   ).length;
...
//                   {activeFilters}
//                 </div>
//                 <div className="text-xs text-gray-500">Filtre{activeFilters !== 1 ? 's' : ''}</div>
//               </div>
//             </div>
